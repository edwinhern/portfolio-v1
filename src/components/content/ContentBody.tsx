...
const ContentBody = ({ post }: BlogContentProps) => {
  ...
  return (
    <main className="mx-auto prose dark:prose-invert prose-lg max-w-prose">
      <div className="text-2xl font-extrabold leading-9 sm:text-3xl sm:leading-10 md:text-4xl md:leading-14">
        {title}
      </div>
      <ContentAvatar
